...
class WebManhuaguiTest {
    ...
    val menu = MangaMenuItem("", "", "", "", "",
        MangaWebSource.LOCAL).apply { url = "https://www.manhuagui.com/comic/18467/" }
    ...
    fun getHiddenChapterList() {
        menu.apply { url = "https://www.manhuagui.com/comic/19534/" }
        val list = wbp.getChapterList(menu)!!
        println(list.first())
        assertTrue(list.isNotEmpty())
    }
